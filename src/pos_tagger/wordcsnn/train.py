...
if __name__ == '__main__':
    ...
    argparser.add_argument('--sufvocab', default='../train02-21.suflist', help='suffix vocaburaly')
    argparser.add_argument('--poslist', default='../pentree.poslist', help='POS tag list')
    argparser.add_argument('--wembed', type=int, default=200, help='dimention of word embedding')
    argparser.add_argument('--fembed', type=int, default=20, help='dimention of capitalize and suffix embedding')
    ...
    argparser.add_argument('--lowercase', type=bool, help='lowercasing each words')
